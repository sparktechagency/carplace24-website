      ...
      <Container>
        ...
        <div className="border rounded-md overflow-hidden">
          ...
          <div className="grid grid-cols-5 border-b">
            ...
            {compareCars.map((car) => (
              <div key={car.id} className="p-3 border-r">
                {car.basicInfo.name}
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-5 border-b">
            ...
            {compareCars.map((car) => (
              <div key={car.id} className="p-3 border-r">
                {car.technicalInfo.engineDisplacement}
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-5 border-b">
            ...
            {compareCars.map((car) => (
              <div key={car.id} className="p-3 border-r">
                {car.electricHybridInfo.batteryCapacity}
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-5 border-b">
            ...
            {compareCars.map((car) => (
              <div key={car.id} className="p-3 border-r">
                {car.electricHybridInfo.towingCapacity}
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-5 border-b">
            ...
            {compareCars.map((car) => (
              <div key={car.id} className="p-3 border-r">
                {car.electricHybridInfo.totalWeight}
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-5 border-b">
            ...
            {compareCars.map((car) => (
              <div key={car.id} className="p-3 border-r">
                {car.electricHybridInfo.curbWeight}
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-5 border-b">
            ...
            {compareCars.map((car) => (
              <div key={car.id} className="p-3 border-r">
                {car.equipment.adaptiveHeadlights}
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-5 border-b">
            ...
            {compareCars.map((car) => (
              <div key={car.id} className="p-3 border-r">
                {car.fuelConsumption.coEmissions}
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-5 border-b">
            ...
            {compareCars.map((car) => (
              <div key={car.id} className="p-3 border-r">
                {car.fuelConsumption.energyEfficiencyClass}
              </div>
            ))}
          </div>
